...
@@ -159,24 +82,51 @@ export default function DashboardLayout() {
...
// Reconstruct layouts based on the widget constraints (minW/minH)
      Object.keys(newLayouts).forEach((key) => {
        newLayouts[key] = updateLayoutForWidget(
          newLayouts[key],
@@ -185,29 +135,32 @@ export default function DashboardLayout() {
        );
      });
...
@@ -216,33 +169,46 @@ export default function DashboardLayout() {
...
if (user.isSuperuser()) {
      ...
      layouts.push({
        w: 6,
@@ -261,123 +227,154 @@ export default function DashboardLayout() {
      lg: layouts
    };
  }, [user]);
